    ...
    <div className="w-full min-h-screen relative bg-background overflow-x-hidden flex flex-col justify-start items-center">
      <div className="relative flex flex-col justify-start items-center w-full">
        ...
        <div className="w-full max-w-none px-4 sm:px-6 md:px-8 lg:px-0 lg:max-w-[1060px] lg:w-[1060px] relative flex flex-col justify-start items-start min-h-screen">
          {/* Left vertical line */}
          <div className="w-[1px] h-full absolute left-4 sm:left-6 md:left-8 lg:left-0 top-0 bg-border shadow-[1px_0px_0px_rgba(255,255,255,0.05)] z-0"></div>

          {/* Right vertical line */}
          <div className="w-[1px] h-full absolute right-4 sm:right-6 md:right-8 lg:right-0 top-0 bg-border shadow-[1px_0px_0px_rgba(255,255,255,0.05)] z-0"></div>
          ...
          <div className="self-stretch pt-[9px] overflow-hidden border-b border-border flex flex-col justify-center items-center gap-4 sm:gap-6 md:gap-8 lg:gap-[66px] relative z-10">
            ...
            <div className="w-full h-12 sm:h-14 md:h-16 lg:h-[84px] absolute left-0 top-0 flex justify-center items-center z-20 px-6 sm:px-8 md:px-12 lg:px-0">
              <div className="w-full h-0 absolute left-0 top-6 sm:top-7 md:top-8 lg:top-[42px] border-t border-border shadow-[0px_1px_0px_rgba(255,255,255,0.05)]"></div>

              <div className="w-full max-w-[calc(100%-32px)] sm:max-w-[calc(100%-48px)] md:max-w-[calc(100%-64px)] lg:max-w-[700px] lg:w-[700px] h-10 sm:h-11 md:h-12 py-1.5 sm:py-2 px-3 sm:px-4 md:px-4 pr-2 sm:pr-3 bg-background backdrop-blur-sm shadow-[0px_0px_0px_2px_rgba(255,255,255,0.1)] overflow-hidden rounded-[50px] flex justify-between items-center relative z-30 border border-border">
            ...
            <div className="pt-16 sm:pt-20 md:pt-24 lg:pt-[216px] pb-8 sm:pb-12 md:pb-16 flex flex-col justify-start items-center px-2 sm:px-4 md:px-8 lg:px-0 w-full sm:pl-0 sm:pr-0 pl-0 pr-0">
              <div className="w-full max-w-[937px] lg:w-[937px] flex flex-col justify-center items-center gap-3 sm:gap-4 md:gap-5 lg:gap-6">
                <div className="self-stretch rounded-[3px] flex flex-col justify-center items-center gap-4 sm:gap-5 md:gap-6 lg:gap-8">
                  <div className="w-full max-w-[848px] lg:w-[848px] text-center flex justify-center flex-col text-foreground text-[28px] xs:text-[32px] sm:text-[42px] md:text-[58px] lg:text-[72px] font-bold leading-[1.05] sm:leading-[1.1] md:leading-[1.1] lg:leading-[1.1] font-sans px-2 sm:px-4 md:px-0 tracking-tight">
                    Debug webhooks with
                    <br />
                    <span className="text-primary">persistent storage</span>
                  </div>
                  <div className="w-full max-w-[606px] lg:w-[606px] text-center flex justify-center flex-col text-muted-foreground sm:text-lg md:text-xl leading-[1.5] sm:leading-[1.55] md:leading-[1.6] lg:leading-[1.65] font-sans px-2 sm:px-4 md:px-0 lg:text-lg font-normal text-base">
                    Inspect payloads, replay requests, and monitor webhooks in
                    real-time.
                    <br className="hidden sm:block" />
                    Never lose a webhook event again with automatic persistence.
                  </div>
                </div>
              </div>
              ...
              <div className="w-full max-w-[960px] lg:w-[960px] pt-2 sm:pt-4 pb-6 sm:pb-8 md:pb-10 px-2 sm:px-4 md:px-6 lg:px-11 flex flex-col justify-center items-center gap-2 relative z-5 my-8 sm:my-12 md:my-16 lg:my-16 mb-0 lg:pb-0">
                <div className="w-full max-w-[960px] lg:w-[960px] h-[200px] sm:h-[280px] md:h-[450px] lg:h-[695.55px] bg-card shadow-[0px_0px_0px_0.9056603908538818px_rgba(255,255,255,0.1),0px_8px_32px_rgba(0,0,0,0.4)] overflow-hidden rounded-[6px] sm:rounded-[8px] lg:rounded-[9.06px] flex flex-col justify-start items-start border border-border">
                  {/* Dashboard Content */}
                        ...
                        >
                          <div className="flex flex-col gap-3 sm:gap-4 h-full">
                            <div className="flex items-center justify-between">
                              <div className="text-foreground font-semibold text-sm sm:text-base md:text-lg">
                                Recent Webhooks
                              </div>
                              <div className="flex gap-2">
                                <div className="px-2 sm:px-3 py-1 bg-primary/20 text-primary rounded text-xs sm:text-sm font-mono">
                                  POST
                                </div>
                                <div className="px-2 sm:px-3 py-1 bg-green-500/20 text-green-400 rounded text-xs sm:text-sm">
                                  200 OK
                                </div>
                              </div>
                            </div>
                            <div className="flex-1 bg-card border border-border rounded-lg p-3 sm:p-4 overflow-hidden">
                              <div className="font-mono text-[10px] sm:text-xs md:text-sm text-muted-foreground space-y-1 sm:space-y-2">
                                ...
                                <div className="pl-3 sm:pl-4">
                                  ...
                                  :{' '}
                                  <span className="text-yellow-400">4999</span>,
                                </div>
                                <div className="pl-3 sm:pl-4">
                                  <span className="text-purple-400">
                                    "timestamp"
                          ...
                          <div className="flex flex-col gap-3 sm:gap-4 h-full">
                            ...
                            <div className="space-y-2 sm:space-y-3">
                              {[1, 2, 3].map((i) => (
                                <div
                                  key={i}
                                  className="bg-card border border-border rounded-lg p-2 sm:p-3 flex items-center justify-between"
                                >
                                  ...
                                  <button className="px-2 sm:px-3 py-1 bg-primary/20 hover:bg-primary/30 text-primary rounded text-xs sm:text-sm transition-colors">
                                    Replay
                                  </button>
                                </div>
                              ))}
                          ...
                          <div className="flex flex-col gap-3 sm:gap-4 h-full">
                            ...
                            <div className="grid grid-cols-2 gap-2 sm:gap-3">
                              <div className="bg-card border border-border rounded-lg p-2 sm:p-3">
                                ...
                                <div className="text-foreground text-lg sm:text-xl md:text-2xl font-bold">
                                  1,247
                                </div>
                              </div>
                              <div className="bg-card border border-border rounded-lg p-2 sm:p-3">
                                ...
                                <div className="text-green-400 text-lg sm:text-xl md:text-2xl font-bold">
                                  98.5%
                                </div>
                              </div>
                            </div>
              ...
              <div className="self-stretch border-t border-border border-b border-border flex justify-center items-start">
                ...
                <div className="flex-1 px-0 sm:px-2 md:px-0 flex flex-col md:flex-row justify-center items-stretch gap-0">
                  ...
                  <FeatureCard
                    ...
                    description="View complete webhook payloads with syntax highlighting and search capabilities."
                  ...
                  <FeatureCard
                    ...
                    description="Replay any webhook to your endpoint for testing and debugging purposes."
                ...
                <div className="self-stretch px-4 sm:px-6 md:px-24 py-8 sm:py-12 md:py-16 border-b border-border flex justify-center items-center gap-6">
                  <div className="w-full max-w-[586px] px-4 sm:px-6 py-4 sm:py-5 overflow-hidden rounded-lg flex flex-col justify-start items-center gap-3 sm:gap-4">
                    ...
                    <div className="self-stretch text-center text-muted-foreground text-sm sm:text-base font-normal leading-6 sm:leading-7 font-sans">
                      Thousands of developers rely on WebhookTest
                      <br className="hidden sm:block" />
                      to debug and monitor their webhook integrations.
                    </div>
                  </div>
                </div>
                ...
                <div className="self-stretch px-4 sm:px-6 md:px-8 lg:px-0 lg:max-w-[1060px] lg:w-[1060px] py-8 sm:py-12 md:py-16 border-b border-border flex justify-center items-center gap-6">
                  <div className="w-full max-w-[616px] lg:w-[616px] px-4 sm:px-6 py-4 sm:py-5 overflow-hidden rounded-lg flex flex-col justify-start items-center gap-3 sm:gap-4">
                    <Badge
                      ...
                      text="Features"
                    />
                    <div className="w-full max-w-[598.06px] lg:w-[598.06px] text-center flex justify-center flex-col text-foreground text-xl sm:text-2xl md:text-3xl lg:text-5xl font-bold leading-tight md:leading-[60px] font-sans tracking-tight">
                      Everything you need to test webhooks
                    </div>
                    <div className="self-stretch text-center text-muted-foreground text-sm sm:text-base font-normal leading-6 sm:leading-7 font-sans">
                      Powerful features designed for developers who need
                      <br />
                      reliable webhook testing and debugging tools.
                    </div>
                  </div>
                </div>
  ...
  return (
    <div
      className={`w-full md:flex-1 self-stretch px-6 py-5 overflow-hidden flex flex-col justify-start items-start gap-2 cursor-pointer relative border-b md:border-b-0 last:border-b-0 transition-all ${
        isActive
          ? 'bg-card shadow-[0px_0px_0px_0.75px_rgba(255,255,255,0.1)_inset] border-primary/30'
          : 'border-l-0 border-r-0 md:border border-border hover:bg-card/50'
      }`}
      onClick={onClick}
    >
      {isActive && (
