...
function Badge({ icon, text }: { icon: React.ReactNode; text: string }) {
  return (
    <div className="px-[14px] py-[6px] shadow-[0px_0px_0px_4px_rgba(255,255,255,0.05)] overflow-hidden rounded-[90px] flex justify-start items-center gap-[8px] border">
      <div className="w-[14px] h-[14px] relative overflow-hidden flex items-center justify-center">
        {icon}
      </div>
      <div className="text-center flex justify-center flex-col text-xs font-medium leading-3 font-sans">
        {text}
      </div>
    </div>
  )
              ...
              <div className="w-full max-w-[calc(100%-32px)] sm:max-w-[calc(100%-48px)] md:max-w-[calc(100%-64px)] lg:max-w-[700px] lg:w-[700px] h-10 sm:h-11 md:h-12 py-1.5 sm:py-2 px-3 sm:px-4 md:px-4 pr-2 sm:pr-3 bg-background backdrop-blur-sm shadow-[0px_0px_0px_2px_rgba(255,255,255,0.1)] overflow-hidden rounded-[50px] flex justify-between items-center relative z-30 border border-border">
                ...
                <div className="h-6 sm:h-7 md:h-8 flex justify-start items-start gap-2 sm:gap-3">
                  <div className="px-2 sm:px-3 md:px-[14px] py-1 sm:py-[6px] bg-secondary hover:bg-secondary/80 transition-colors shadow-[0px_1px_2px_rgba(0,0,0,0.3)] overflow-hidden rounded-full flex justify-center items-center cursor-pointer border border-border">
                    <Link
                      href={ROUTES.SIGN_IN}
                      className="flex flex-col justify-center text-foreground text-xs md:text-[13px] font-medium leading-5 font-sans"
                    >
                      {t('Buttons.SignIn')}
                    </Link>
                  </div>
            ...
            <div className="pt-16 sm:pt-20 md:pt-24 lg:pt-[216px] pb-8 sm:pb-12 md:pb-16 flex flex-col justify-start items-center px-2 sm:px-4 md:px-8 lg:px-0 w-full sm:pl-0 sm:pr-0 pl-0 pr-0">
              ...
              <div className="self-stretch border-t border-border border-b border-border flex justify-center items-start">
                ...
                <div className="flex-1 px-0 sm:px-2 md:px-0 flex flex-col md:flex-row justify-center items-stretch gap-0">
                  {/* Feature Cards */}
                  <FeatureCard
                    title={t('FeatureCards.Feature1.Title')}
                    description={t('FeatureCards.Feature1.Description')}
                    isActive={activeCard === 0}
                    progress={activeCard === 0 ? progress : 0}
                    onClick={() => handleCardClick(0)}
                  />
                  <FeatureCard
                    title={t('FeatureCards.Feature2.Title')}
                    description={t('FeatureCards.Feature2.Description')}
                    isActive={activeCard === 1}
                    progress={activeCard === 1 ? progress : 0}
                    onClick={() => handleCardClick(1)}
                  />
                  <FeatureCard
                    title={t('FeatureCards.Feature3.Title')}
                    description={t('FeatureCards.Feature3.Description')}
