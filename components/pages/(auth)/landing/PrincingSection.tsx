    ...
    <div className="w-full flex flex-col justify-center items-center gap-2">
      ...
      <div className="self-stretch border-b border-t border-[rgba(55,50,47,0.12)] flex justify-center items-center">
        <div className="flex justify-center items-start w-full">
          ...
          <div className="flex-1 flex flex-col md:flex-row justify-center items-stretch gap-0 py-12 md:py-0 max-w-[800px]">
            {/* Free Plan */}
            <div className="flex-1 max-w-full md:max-w-none self-stretch px-8 py-8 border border-[rgba(50,45,43,0.12)] border-[#E0DEDB] md:border-r-0 overflow-hidden flex flex-col justify-start items-start gap-12 bg-[rgba(255,255,255,0)]">
              {/* Plan Header */}
            ...
            {/* Plus Plan (Featured) */}
            <div className="flex-1 max-w-full md:max-w-none self-stretch px-8 py-8 bg-[#37322F] border border-[rgba(50,45,43,0.12)] border-[rgba(55,50,47,0.12)] overflow-hidden flex flex-col justify-start items-start gap-12">
              {/* Plan Header */}
              <div className="self-stretch flex flex-col justify-start items-center gap-9">
                <div className="self-stretch flex flex-col justify-start items-start gap-2">
